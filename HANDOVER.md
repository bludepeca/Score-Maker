...
Si estás leyendo esto, es porque Lautaro ha cambiado de PC y necesitas ponerte al corriente con todo el progreso de la aplicación *ScoreMaker*. Aquí tienes el contexto exacto de dónde lo dejamos:
...
Lautaro quiere enfocarse en lo siguiente:
...
Lautaro, para usar este repo en tu Windows 10:
